...
ActiveRecord::Schema.define(version: 20170709083510) do
  ...
  create_table "companies_fields", id: false, force: :cascade do |t|
    ...
    t.index ["company_id", "field_id"], name: "index_companies_fields_on_company_id_and_field_id", using: :btree
  end
  ...
  create_table "education_items", force: :cascade do |t|
    ...
    t.index ["location_id"], name: "index_education_items_on_location_id", using: :btree
  end
  ...
  create_table "offer_saves", force: :cascade do |t|
    t.integer  "user_id"
    t.integer  "offer_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["offer_id"], name: "index_offer_saves_on_offer_id", using: :btree
  end
  ...
  create_table "offers", force: :cascade do |t|
    ...
    t.index ["published_at"], name: "index_offers_on_published_at", using: :btree
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["contact_email"], name: "index_users_on_contact_email", using: :btree
  ...
  create_table "work_items", force: :cascade do |t|
    ...
    t.string   "organization"
    t.integer  "location_id"
    t.index ["location_id"], name: "index_work_items_on_location_id", using: :btree
  end
