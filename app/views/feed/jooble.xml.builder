...
xml.jobs do
  @offers.each do |offer|
    xml.job do
      ...
      # TODO: Should be application_url_for, but that doesn't work out well
      xml.apply_url { xml.cdata! offer_url(offer) }
      ...
      xml.segmentation { xml.cdata! "promo_#{!!offer.featured?}" }
    end
  end
end
